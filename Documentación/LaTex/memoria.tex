...
Nuestro trabajo consistirá en mejorar la sensación del cliente con la aplicación, ampliando funcionalidades ya existentes y creando nuevas herramientas que faciliten el trabajo a los docentes. A su vez, realizaremos el despliegue de nuestra aplicación en un servidor web de manera que ésta sea accesible desde cualquier punto de la Universidad de Burgos y, por tanto, pueda utilizarse impartiendo docencia.
\end{abstract}
