...
\imagen{sprint-1}{Progreso en el \textit{sprint} 1.}
...
\imagen{sprint-2}{Progreso en el \textit{sprint} 2.}
...
\imagen{sprint-3}{Progreso en el \textit{sprint} 3.}
...
\imagen{sprint-4}{Progreso en el \textit{sprint} 4.}
...
\imagen{sprint-5}{Progreso en el \textit{sprint} 5.}
...
\imagen{sprint-6}{Progreso en el \textit{sprint} 6.}
...
\imagen{sprint-7}{Progreso en el \textit{sprint} 7.}
...
\imagen{sprint-8}{Progreso en el \textit{sprint} 8.}
...
Podemos observar el progreso del \textit{sprint} en la figura~\ref{fig:sprint-8}
\imagen{sprint-9}{Progreso en el \textit{sprint} 9.}
