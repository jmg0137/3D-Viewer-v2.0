...
\imagen{sprint-18}{Progreso en el \textit{sprint} 18.}{0.9}
...
Podemos observar el progreso del \textit{sprint} en la figura~\ref{fig:sprint-19}
\imagen{sprint-19}{Progreso en el \textit{sprint} 19.}{0.9}
